...
type FloatingIPLister interface {
	...
	List(selector labels.Selector) (ret []*rancherk8sbinbashorgv1beta2.FloatingIP, err error)
...
type floatingIPLister struct {
	listers.ResourceIndexer[*rancherk8sbinbashorgv1beta2.FloatingIP]
}

// NewFloatingIPLister returns a new FloatingIPLister.
func NewFloatingIPLister(indexer cache.Indexer) FloatingIPLister {
	return &floatingIPLister{listers.New[*rancherk8sbinbashorgv1beta2.FloatingIP](indexer, rancherk8sbinbashorgv1beta2.Resource("floatingip"))}
}

// FloatingIPs returns an object that can list and get FloatingIPs.
func (s *floatingIPLister) FloatingIPs(namespace string) FloatingIPNamespaceLister {
	return floatingIPNamespaceLister{listers.NewNamespaced[*rancherk8sbinbashorgv1beta2.FloatingIP](s.ResourceIndexer, namespace)}
}
...
type FloatingIPNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*rancherk8sbinbashorgv1beta2.FloatingIP, error)
